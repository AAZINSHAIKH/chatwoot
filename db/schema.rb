...
ActiveRecord::Schema[7.1].define(version: 2025_05_23_031839) do
  ...
  create_table "ai_agent_assistant_responses", force: :cascade do |t|
    ...
    t.index ["account_id"], name: "index_ai_agent_assistant_responses_on_account_id"
    t.index ["assistant_id"], name: "index_ai_agent_assistant_responses_on_assistant_id"
    ...
    t.index ["status"], name: "index_ai_agent_assistant_responses_on_status"
  end
  ...
  create_table "ai_agent_documents", force: :cascade do |t|
    ...
    t.index ["assistant_id", "external_link"], name: "index_ai_agent_documents_on_assistant_id_and_external_link", unique: true
    t.index ["assistant_id"], name: "index_ai_agent_documents_on_assistant_id"
  ...
  create_table "ai_agent_inboxes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ai_agent_assistant_id", "inbox_id"], name: "index_ai_agent_inboxes_on_ai_agent_assistant_id_and_inbox_id", unique: true
