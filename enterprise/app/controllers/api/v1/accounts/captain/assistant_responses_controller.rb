class Api::V1::Accounts::Captain::AssistantResponsesController < Api::V1::Accounts::BaseController
  ...
  def set_assistant
    @assistant = Current.account.captain_assistants.find_by(id: params[:topic_id])
  end

  def set_responses
    @responses = Current.account.captain_topic_responses.includes(:assistant, :documentable).ordered
  end
