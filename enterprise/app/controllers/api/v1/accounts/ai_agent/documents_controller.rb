class Api::V1::Accounts::AiAgent::DocumentsController < Api::V1::Accounts::BaseController
  ...
  def set_documents
    @documents = Current.account.ai_agent_documents.includes(:assistant).ordered
  end
  ...
  def set_assistant
    @assistant = Current.account.ai_agent_assistants.find_by(id: document_params[:assistant_id])
  end
