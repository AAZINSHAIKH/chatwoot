class Api::V1::Accounts::AiAgent::InboxesController < Api::V1::Accounts::BaseController
  ...
  def create
    ...
    @ai_agent_inbox = @assistant.ai_agent_inboxes.build(inbox: inbox)
    @ai_agent_inbox.save!
  end

  def destroy
    @ai_agent_inbox = @assistant.ai_agent_inboxes.find_by!(inbox_id: permitted_params[:inbox_id])
  ...
  def account_assistants
    @account_assistants ||= Current.account.ai_agent_assistants
  end
