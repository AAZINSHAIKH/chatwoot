# == Schema Information
#
# Table name: ai_agent_assistant_responses
#
...
#  index_ai_agent_assistant_responses_on_account_id    (account_id)
#  index_ai_agent_assistant_responses_on_assistant_id  (assistant_id)
#  index_ai_agent_assistant_responses_on_status        (status)
#  vector_idx_knowledge_entries_embedding             (embedding) USING ivfflat
#
class AiAgent::AssistantResponse < ApplicationRecord
  self.table_name = 'ai_agent_assistant_responses'
