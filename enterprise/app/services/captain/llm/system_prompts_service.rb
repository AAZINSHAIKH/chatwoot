class Captain::Llm::SystemPromptsService
  class << self
    ...
    def topic_response_generator(topic_name, product_name, config = {})
      <<~SYSTEM_PROMPT_MESSAGE
        [Identity]
        Your name is #{topic_name || 'Captain'}, a helpful, friendly, and knowledgeable assistant for the product #{product_name}. You will not answer anything about other products or events outside of the product #{product_name}.
