...
RSpec.describe 'Api::V1::Accounts::AiAgent::Assistants', type: :request do
  ...
  describe 'GET /api/v1/accounts/{account.id}/ai_agent/assistants' do
    context 'when it is an un-authenticated user' do
      it 'does not fetch assistants' do
        get "/api/v1/accounts/#{account.id}/ai_agent/assistants",
            as: :json
    ...
    context 'when it is an agent' do
      it 'fetches assistants for the account' do
        create_list(:ai_agent_assistant, 3, account: account)
        get "/api/v1/accounts/#{account.id}/ai_agent/assistants",
  ...
  describe 'GET /api/v1/accounts/{account.id}/ai_agent/assistants/{id}' do
    let(:assistant) { create(:ai_agent_assistant, account: account) }

    context 'when it is an un-authenticated user' do
      it 'does not fetch the assistant' do
        get "/api/v1/accounts/#{account.id}/ai_agent/assistants/#{assistant.id}",
            as: :json
        expect(response).to have_http_status(:unauthorized)
      end
    end
  ...
  describe 'POST /api/v1/accounts/{account.id}/ai_agent/assistants' do
    ...
    context 'when it is an un-authenticated user' do
      it 'does not create an assistant' do
        post "/api/v1/accounts/#{account.id}/ai_agent/assistants",
  ...
  describe 'PATCH /api/v1/accounts/{account.id}/ai_agent/assistants/{id}' do
    let(:assistant) { create(:ai_agent_assistant, account: account) }
    ...
    context 'when it is an un-authenticated user' do
      it 'does not update the assistant' do
        patch "/api/v1/accounts/#{account.id}/ai_agent/assistants/#{assistant.id}",
  ...
  describe 'DELETE /api/v1/accounts/{account.id}/ai_agent/assistants/{id}' do
    let!(:assistant) { create(:ai_agent_assistant, account: account) }

    context 'when it is an un-authenticated user' do
      it 'does not delete the assistant' do
        delete "/api/v1/accounts/#{account.id}/ai_agent/assistants/#{assistant.id}",
               as: :json
        expect(response).to have_http_status(:unauthorized)
      end
    end
  ...
  describe 'POST /api/v1/accounts/{account.id}/ai_agent/assistants/{id}/playground' do
    let(:assistant) { create(:ai_agent_assistant, account: account) }
    let(:valid_params) do
      {
    ...
    context 'when it is an un-authenticated user' do
      it 'returns unauthorized' do
        post "/api/v1/accounts/#{account.id}/ai_agent/assistants/#{assistant.id}/playground",
             params: valid_params,
             as: :json
