...
RSpec.describe 'Api::V1::Accounts::Captain::AssistantResponses', type: :request do
  ...
  describe 'GET /api/v1/accounts/:account_id/captain/topic_responses/:id' do
    let!(:response_record) { create(:captain_topic_response, assistant: assistant, account: account) }
  ...
  describe 'PATCH /api/v1/accounts/:account_id/captain/topic_responses/:id' do
    let!(:response_record) { create(:captain_topic_response, assistant: assistant) }
