...
RSpec.describe Message do
  ...
  it 'updates first reply if the message is human and even if there are messages from ai_agent' do
    ai_agent_assistant = create(:ai_agent_assistant, account: conversation.account)
    ...
    create(:message, message_type: :outgoing, conversation: conversation, sender: ai_agent_assistant)
