...
describe AiAgentListener do
  ...
  let(:assistant) { create(:ai_agent_assistant, account: account, config: { feature_memory: true, feature_faq: true }) }
  ...
  describe '#conversation_resolved' do
    ...
    before do
      create(:ai_agent_inbox, ai_agent_assistant: assistant, inbox: inbox)
    end
