...
const formState = {
  ...
  assistants: useMapGetter('ai_agentAssistants/getRecords'),
};
  ...
  <form class="flex flex-col gap-4" @submit.prevent="handleSubmit">
    ...
    <div class="flex flex-col gap-1">
      <label for="assistant" class="mb-0.5 text-sm font-medium text-n-slate-12">
        {{ t('AI_AGENT.DOCUMENTS.FORM.ASSISTANT.LABEL') }}
      </label>
      <ComboBox
        id="assistant"
        ...
        :placeholder="t('AI_AGENT.DOCUMENTS.FORM.ASSISTANT.PLACEHOLDER')"
