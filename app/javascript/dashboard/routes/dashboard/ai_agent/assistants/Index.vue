...
import AssistantCard from 'dashboard/components-next/ai_agent/assistant/AssistantCard.vue';
...
import CreateAssistantDialog from 'dashboard/components-next/ai_agent/pageComponents/assistant/CreateAssistantDialog.vue';
import AssistantPageEmptyState from 'dashboard/components-next/ai_agent/pageComponents/emptyStates/AssistantPageEmptyState.vue';
...
const uiFlags = useMapGetter('ai_agentAssistants/getUIFlags');
const assistants = useMapGetter('ai_agentAssistants/getRecords');
...
onMounted(() => store.dispatch('ai_agentAssistants/get'));
</script>
  ...
  >
    <template #knowMore>
      <FeatureSpotlightPopover
        ...
        fallback-thumbnail="/assets/images/dashboard/ai_agent/assistant-popover-light.svg"
        fallback-thumbnail-dark="/assets/images/dashboard/ai_agent/assistant-popover-dark.svg"
        learn-more-url="https://chwt.app/ai_agent-assistant"
      />
    </template>
    <template #emptyState>
